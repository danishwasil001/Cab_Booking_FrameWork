...
def Validate_cr():
    ...
    if a == 'Admin' and b == 'admin':
        ...
        showinfo(title="Logged in ", message="You are logged in")
    else:
        showerror(title="Error", message="Username or Password is incorrect")
...
Button(root, text='Login Now', width=20, bg='red', fg='black', command=Validate_cr).place(x=180, y=280)
